...
class MembershipResourceApi
{
    ...
    /**
     * Operation enrolMembershipsUsingPOST
     *
     * enrolMemberships
     *
     * @param  \Idealogic\MembershipAPI\Model\MembershipDTO[] $membership_dt_os membershipDTOs (required)
     * @param  int $membership_type_id membershipTypeId (required)
     *
     * @throws \Idealogic\MembershipAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Idealogic\MembershipAPI\Model\MembershipDTO[]
     */
    public function enrolMembershipsUsingPOST($membership_dt_os, $membership_type_id)
    {
        list($response) = $this->enrolMembershipsUsingPOSTWithHttpInfo($membership_dt_os, $membership_type_id);
        return $response;
    }

    /**
     * Operation enrolMembershipsUsingPOSTWithHttpInfo
     *
     * enrolMemberships
     *
     * @param  \Idealogic\MembershipAPI\Model\MembershipDTO[] $membership_dt_os membershipDTOs (required)
     ...
     * @return array of \Idealogic\MembershipAPI\Model\MembershipDTO[], HTTP status code, HTTP response headers (array of strings)
     */
    public function enrolMembershipsUsingPOSTWithHttpInfo($membership_dt_os, $membership_type_id)
    {
        $returnType = '\Idealogic\MembershipAPI\Model\MembershipDTO[]';
        $request = $this->enrolMembershipsUsingPOSTRequest($membership_dt_os, $membership_type_id);
    ...
    /**
     * Operation enrolMembershipsUsingPOSTAsync
     *
     * enrolMemberships
     *
     * @param  \Idealogic\MembershipAPI\Model\MembershipDTO[] $membership_dt_os membershipDTOs (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function enrolMembershipsUsingPOSTAsync($membership_dt_os, $membership_type_id)
    {
        return $this->enrolMembershipsUsingPOSTAsyncWithHttpInfo($membership_dt_os, $membership_type_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation enrolMembershipsUsingPOSTAsyncWithHttpInfo
     *
     * enrolMemberships
     *
     * @param  \Idealogic\MembershipAPI\Model\MembershipDTO[] $membership_dt_os membershipDTOs (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function enrolMembershipsUsingPOSTAsyncWithHttpInfo($membership_dt_os, $membership_type_id)
    {
        $returnType = '\Idealogic\MembershipAPI\Model\MembershipDTO[]';
        $request = $this->enrolMembershipsUsingPOSTRequest($membership_dt_os, $membership_type_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function enrolMembershipsUsingPOSTRequest($membership_dt_os, $membership_type_id)
    {
        // verify the required parameter 'membership_dt_os' is set
        if ($membership_dt_os === null || (is_array($membership_dt_os) && count($membership_dt_os) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $membership_dt_os when calling enrolMembershipsUsingPOST'
            );
        }
        ...
        if ($membership_type_id === null || (is_array($membership_type_id) && count($membership_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $membership_type_id when calling enrolMembershipsUsingPOST'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($membership_dt_os)) {
            $_tempBody = $membership_dt_os;
        }
    ...
    /**
     * Operation getMemberStatusByLatestPeriodForMembershipTypeUsingGET
     *
     ...
     */
    public function getMemberStatusByLatestPeriodForMembershipTypeUsingGET($external_user_id, $membership_type_id, $organisation_id = null)
    {
        list($response) = $this->getMemberStatusByLatestPeriodForMembershipTypeUsingGETWithHttpInfo($external_user_id, $membership_type_id, $organisation_id);
        return $response;
    }

    /**
     * Operation getMemberStatusByLatestPeriodForMembershipTypeUsingGETWithHttpInfo
     *
     * getMemberStatusByLatestPeriodForMembershipType
     *
     * @param  string $external_user_id externalUserId (required)
     ...
     */
    public function getMemberStatusByLatestPeriodForMembershipTypeUsingGETWithHttpInfo($external_user_id, $membership_type_id, $organisation_id = null)
    {
        $returnType = '\Idealogic\MembershipAPI\Model\LatestPeriodMembershipStatusResponseDTO';
        $request = $this->getMemberStatusByLatestPeriodForMembershipTypeUsingGETRequest($external_user_id, $membership_type_id, $organisation_id);
    ...
    /**
     * Operation getMemberStatusByLatestPeriodForMembershipTypeUsingGETAsync
     *
     * getMemberStatusByLatestPeriodForMembershipType
     *
     * @param  string $external_user_id externalUserId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMemberStatusByLatestPeriodForMembershipTypeUsingGETAsync($external_user_id, $membership_type_id, $organisation_id = null)
    {
        return $this->getMemberStatusByLatestPeriodForMembershipTypeUsingGETAsyncWithHttpInfo($external_user_id, $membership_type_id, $organisation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMemberStatusByLatestPeriodForMembershipTypeUsingGETAsyncWithHttpInfo
     *
     * getMemberStatusByLatestPeriodForMembershipType
     *
     * @param  string $external_user_id externalUserId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMemberStatusByLatestPeriodForMembershipTypeUsingGETAsyncWithHttpInfo($external_user_id, $membership_type_id, $organisation_id = null)
    {
        $returnType = '\Idealogic\MembershipAPI\Model\LatestPeriodMembershipStatusResponseDTO';
        $request = $this->getMemberStatusByLatestPeriodForMembershipTypeUsingGETRequest($external_user_id, $membership_type_id, $organisation_id);
    ...
    /**
     * Create request for operation 'getMemberStatusByLatestPeriodForMembershipTypeUsingGET'
     *
     * @param  string $external_user_id externalUserId (required)
     * @param  int $membership_type_id membershipTypeId (required)
     * @param  int $organisation_id organisationId (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMemberStatusByLatestPeriodForMembershipTypeUsingGETRequest($external_user_id, $membership_type_id, $organisation_id = null)
    {
        ...
        if ($external_user_id === null || (is_array($external_user_id) && count($external_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $external_user_id when calling getMemberStatusByLatestPeriodForMembershipTypeUsingGET'
            );
        }
        // verify the required parameter 'membership_type_id' is set
        if ($membership_type_id === null || (is_array($membership_type_id) && count($membership_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $membership_type_id when calling getMemberStatusByLatestPeriodForMembershipTypeUsingGET'
            );
        }
        ...
        if ($external_user_id !== null) {
            $queryParams['externalUserId'] = ObjectSerializer::toQueryValue($external_user_id);
        }
        // query params
        if ($membership_type_id !== null) {
            $queryParams['membershipTypeId'] = ObjectSerializer::toQueryValue($membership_type_id);
