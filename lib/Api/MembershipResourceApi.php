...
class MembershipResourceApi
{
     ...
     * getMembershipStatus
     *
     * @param  int $membership_id membershipId (required)
     *
     * @throws \Idealogic\MembershipAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Idealogic\MembershipAPI\Model\OptionalOfMembershipStatusDTO
     */
    public function getMembershipStatusUsingGET($membership_id)
    {
        list($response) = $this->getMembershipStatusUsingGETWithHttpInfo($membership_id);
        return $response;
    }
     ...
     * @throws \Idealogic\MembershipAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Idealogic\MembershipAPI\Model\OptionalOfMembershipStatusDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMembershipStatusUsingGETWithHttpInfo($membership_id)
    {
        $returnType = '\Idealogic\MembershipAPI\Model\OptionalOfMembershipStatusDTO';
        $request = $this->getMembershipStatusUsingGETRequest($membership_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Idealogic\MembershipAPI\Model\OptionalOfMembershipStatusDTO',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMembershipStatusUsingGETAsync($membership_id)
    {
        return $this->getMembershipStatusUsingGETAsyncWithHttpInfo($membership_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMembershipStatusUsingGETAsyncWithHttpInfo($membership_id)
    {
        $returnType = '\Idealogic\MembershipAPI\Model\OptionalOfMembershipStatusDTO';
        $request = $this->getMembershipStatusUsingGETRequest($membership_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMembershipStatusUsingGETRequest($membership_id)
    {
        // verify the required parameter 'membership_id' is set
        if ($membership_id === null || (is_array($membership_id) && count($membership_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $membership_id when calling getMembershipStatusUsingGET'
            );
        }

        $resourcePath = '/api/membershipStatus/{membershipId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
